...
impl NetLogger {
    pub fn new(file_path: &str) -> std::io::Result<Self> {
        ...
        // 初始化 writer 时，写入列标题和说明
        {
            ...
            writeln!(w, "interface,rx_bytes,tx_bytes,rx_packets,tx_packets,rx_dropped,tx_dropped,active_opens,in_segs,out_segs,retrans_segs,in_errs,out_rsts,curr_estab,passive_opens,in_datagrams,out_datagrams,timestamp")?;
        }
