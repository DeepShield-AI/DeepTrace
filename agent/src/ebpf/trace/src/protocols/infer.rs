use super::{
	dns::DNS, http1::HTTP1, memcached::Memcached, mongodb::MongoDB, redis::Redis, thrift::Thrift,
};
use crate::{
...
fn infer_protocol_impl(ctx: &TracePointContext, info: &InferInfo, quintuple: Quintuple) -> Message {
	...
	// TODO: + 用户态可配置的逻辑
	[Redis::parse, Thrift::parse, Memcached::parse, MongoDB::parse, DNS::parse, HTTP1::parse]
		.iter()
